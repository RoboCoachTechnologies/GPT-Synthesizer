# TODO: put workspace description on the left
import logging
import os
...
model_options = ['',':rainbow[GPT-3]', 'Llama 2', 'Other']
...
def main(verbose = False):
    ...
    st.sidebar.markdown("Here you can find all the files generated by GPT Synthesizer so far.")
